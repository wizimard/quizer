import type { IQuestionConfigOrderValuesAnswer, QuestionConfigOrderValues } from '@modules/test-management/entities/question-configs/question-config-order-values';
