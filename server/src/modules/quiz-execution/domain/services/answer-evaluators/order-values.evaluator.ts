import type { IQuestionConfigOrderValuesAnswer, QuestionConfigOrderValues } from '@modules/quiz-management/domain/value-objects/question-configs/question-config-order-values';
