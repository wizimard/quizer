...
import { QuestionEditMemo } from "../QuestionEdit/QuestionEdit";
import { Text } from "@shared/ui/text";
import { useTranslation } from "react-i18next";
import type { Control, FieldArrayWithId, FieldErrors, UseFieldArrayRemove } from "react-hook-form";
import type { IEditQuiz, TQuestionForm } from "@features/quiz/quiz-edit/model/editQuizForm";
...
export const QuizQuestionsSection = ({ control, fieldsQuestions, errors, removeQuestion, changeQuestionType, changeQuestionOrder, appendQuestion }: IQuizQuestionsSectionProps) => {
