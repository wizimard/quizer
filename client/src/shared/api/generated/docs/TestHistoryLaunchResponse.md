...
**user_registered_count** | **number** |  | [default to undefined]
...
```typescript
import { TestHistoryLaunchResponse } from './api';

const instance: TestHistoryLaunchResponse = {
    session_id,
    run_mode,
