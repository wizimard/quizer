		...
		<>
			<div className="flex w-full justify-between">
				...
				<div className="flex gap-2.5">
					<Link to={`/quiz-edit/${id}`} className="flex h-full items-center justify-center text-muted-foreground hover:text-foreground" title="Нажмите, чтобы внести изменения в тест">
